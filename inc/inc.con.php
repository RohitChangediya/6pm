    ...
    function connect( )
    {
        if ( $this->conn == null ) {
            try {
                ...
                $this->conn = new PDO( 'mysql:host=localhost;dbname=6pm', 'root', '' );
                
                /* SERVER CONNECT*/
                /*
                $this->conn = new PDO('mysql:host=localhost;dbname=seascap1_newth', 'seascap1_newth', '9Y@SWg1!0P');
                */
                
                /*
                $this->conn = new PDO('mysql:host=localhost;dbname=seascap1_wp262', 'seascap1_wp262', 'P-65y(2HS7');
                */
